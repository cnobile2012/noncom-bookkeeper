...
class Paths(wx.Panel):
    ...
    def __init__(self, parent, *args, **kwargs):
        ...
        widget_3 = wx.TextCtrl(self, wx.ID_ANY, self.sg.user_config_fullpath,
                               style=wx.TE_READONLY)
        widget_3.SetBackgroundColour(wx.Colour(159, 159, 95))
        widget_3.SetForegroundColour(wx.Colour(50, 50, 204))
        ...
        widget_5 = wx.TextCtrl(self, wx.ID_ANY,
                               ...
                               style=wx.TE_READONLY)
        widget_5.SetBackgroundColour(wx.Colour(159, 159, 95))
        widget_5.SetForegroundColour(wx.Colour(50, 50, 204))
        ...
        widget_7 = wx.TextCtrl(self, wx.ID_ANY, self.sg.user_log_fullpath,
                               style=wx.TE_READONLY)
        widget_7.SetBackgroundColour(wx.Colour(159, 159, 95))
